...
- fix: Extra
  ...
  in [`lts()`](https://mlr3tuningspaces.mlr-org.com/reference/lts.md)
  were not passed to learners created with `$get_learner()`.
- docs: Add
  [`lts()`](https://mlr3tuningspaces.mlr-org.com/reference/lts.md)
  return.
...
- feat: Pass
  [`paradox::TuneToken`](https://paradox.mlr-org.com/reference/to_tune.html)
  to [`lts()`](https://mlr3tuningspaces.mlr-org.com/reference/lts.md) to
